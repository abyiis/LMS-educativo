<template>
  <!-- ✅ FONDO CORREGIDO: Agregado gradiente de fondo -->
  <div class="login-container min-vh-100 d-flex align-items-center justify-content-center py-5">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-8 col-lg-6 col-xl-5">
          ...
          <div class="glass-effect p-4 mt-4 animate-slide-in" style="animation-delay: 0.4s;">
            ...
            <div class="row g-3">
              <div class="col-md-4">
                <div class="p-3 bg-primary bg-opacity-10 rounded-3 hover-lift cursor-pointer"
                     @click="llenarFormulario('admin@lms.com', 'admin123')">
              ...
              <div class="col-md-4">
                <div class="p-3 bg-success bg-opacity-10 rounded-3 hover-lift cursor-pointer"
                     @click="llenarFormulario('docente@lms.com', 'admin123')">
                  <div class="d-flex align-items-center mb-2">
              ...
              <div class="col-md-4">
                <div class="p-3 bg-info bg-opacity-10 rounded-3 hover-lift cursor-pointer"
                     @click="llenarFormulario('estudiante@lms.com', 'admin123')">
                  <div class="d-flex align-items-center mb-2">
...
// ✅ FUNCIÓN PARA AUTOCOMPLETAR (mejora UX)
const llenarFormulario = (email, password) => {
...
<style scoped>
/* ✅ ESTILOS CORREGIDOS CON GRADIENTE DE FONDO */
.login-container {
